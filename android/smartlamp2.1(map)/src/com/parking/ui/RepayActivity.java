...
public class RepayActivity extends ActivityBase implements OnClickListener {
		...
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					Toast.makeText(RepayActivity.this, "֧���ɹ�",
							Toast.LENGTH_SHORT).show();
				} else {
					
					if (TextUtils.equals(resultStatus, "8000")) {
						Toast.makeText(RepayActivity.this, "֧�����ȷ����",
								Toast.LENGTH_SHORT).show();

					} else {
						
						Toast.makeText(RepayActivity.this, "֧��ʧ��",
								Toast.LENGTH_SHORT).show();
	...
	private void init() {
	    ...
	    repaysn= sp.getString("repaysn", "repaysn");
		String repaymoney=sp.getString("repaymoney", "repaymoney");
		
		purse_money.setText("����ǰ��ͣ������:"+repaymoney+"Ԫ");
	...
	public void onClick(View v) {
		...
		if (v == top_fanhui) {
			//finish();
			Intent it = getIntent();
			RepayActivity.this.setResult(ResultCode, it);
	...
	public void payqq() {
		...
		Toast.makeText(RepayActivity.this, "��ȡ������...", Toast.LENGTH_SHORT)
				.show();
		try {
			...
			if (null != json && !json.has("retcode")) {
				...
				Toast.makeText(RepayActivity.this, "��������֧��", Toast.LENGTH_SHORT)
						.show();
				// ��֧��֮ǰ�����Ӧ��û��ע�ᵽ΢�ţ�Ӧ���ȵ���IWXMsg.registerApp��Ӧ��ע�ᵽ΢��
				api.sendReq(req);
			} else {
				Log.d("PAY_GET", "���ش���" + json.getString("retmsg"));
				Toast.makeText(RepayActivity.this,
			...
			Toast.makeText(RepayActivity.this, "�쳣��" + e.getMessage(),
					Toast.LENGTH_SHORT).show();
		}
	...
	private void getGoodsList() {
		 myDialog= new ProDialog(RepayActivity.this,
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					String url = UrlUtil.getUserUrl() + "app/payment/" + repaysn;
...
//						}
	...
	public void alipay() {
		...
		Runnable payRunnable = new Runnable() {
			...
			public void run() {
				// ����PayTask ����
				PayTask alipay = new PayTask(RepayActivity.this);
				// ����֧���ӿڣ���ȡ֧�����
