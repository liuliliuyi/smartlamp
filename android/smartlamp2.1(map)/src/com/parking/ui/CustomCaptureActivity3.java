...
public class CustomCaptureActivity3 extends CaptureActivity {
...
//        tvTitle.setText("安装");
    ...
    public boolean onResultCallback(String result) {
			 ...
			 it.putExtras(b);
			 it.setClass(this, CarnavActivity1.class);
			 startActivity(it);
   ...
   public   void showCustomToast(String text) {
		...
		View toastRoot = LayoutInflater.from(CustomCaptureActivity3.this).inflate(R.layout.common_toast, null);
	
		((TextView) toastRoot.findViewById(R.id.toast_text)).setText(text);
		Toast toast = new Toast(CustomCaptureActivity3.this);
