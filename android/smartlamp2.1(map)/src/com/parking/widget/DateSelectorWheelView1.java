 ...
 */
public class DateSelectorWheelView1 extends RelativeLayout implements
	...
	public DateSelectorWheelView1(Context context, AttributeSet attrs,
			int defStyleAttr) {
	...
	public DateSelectorWheelView1(Context context) {
		super(context);
		initLayout(context);
	}
